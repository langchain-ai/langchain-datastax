...
class AstraDBVectorStore(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        Note:
            For concurrency in synchronous [add_texts](langchain_astradb.AstraDBVectorStore.add_texts):, as a rule of thumb,
            ...
            [add_texts](langchain_astradb.AstraDBVectorStore.add_texts) and [add_documents](langchain_astradb.AstraDBVectorStore.add_documents) as well.
        """
    ...
    async def adelete_collection(self) -> None:
        ...
        Completely delete the collection from the database (as opposed
        to [aclear](langchain_astradb.AstraDBVectorStore.aclear), which empties it only).
        Stored data is lost and unrecoverable, resources are freed.
        Use with caution.
        """
        await self.astra_env.aensure_db_setup()
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: you can pass any argument that you would
                to [add_texts](langchain_astradb.AstraDBVectorStore.add_texts) and/or to the
    ...
    async def afrom_texts(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            ids: ids to associate to the texts.
            **kwargs: you can pass any argument that you would
                to [aadd_texts](langchain_astradb.AstraDBVectorStore.aadd_texts) and/or to the `AstraDBVectorStore`
    ...
    def from_documents(
        ...
        **kwargs: Any,
        ...
        Utility method that defers to [from_texts](langchain_astradb.AstraDBVectorStore.from_texts) (see).
    ...
    async def afrom_documents(
        ...
        **kwargs: Any,
        ...
        Utility method that defers to [afrom_texts](langchain_astradb.AstraDBVectorStore.afrom_texts) (see that one).

        Args:
            documents: a list of `Document` objects for insertion in the store.
            embedding: the embedding function to use in the store.
            **kwargs: you can pass any argument that you would
                to [aadd_texts](langchain_astradb.AstraDBVectorStore.aadd_texts) and/or to the
                `AstraDBVectorStore` constructor (see these methods for
                details). These arguments will be
                routed to the respective methods as they are.
